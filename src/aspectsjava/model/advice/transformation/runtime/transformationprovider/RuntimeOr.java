...
public class RuntimeOr implements RuntimeExpressionProvider<PointcutExpressionOr<?>> {

	@Override
	public Expression<?> getExpression(PointcutExpressionOr<?> expression, NamingRegistry<RuntimePointcutExpression<?>> namingRegistry) {
		PointcutExpressionOr<?> expr = (PointcutExpressionOr<?>) expression.origin();
