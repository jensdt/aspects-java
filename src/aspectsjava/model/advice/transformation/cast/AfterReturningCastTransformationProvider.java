...
public class AfterReturningCastTransformationProvider extends CastTransformationProvider {
	@Override
	protected Block getBody(WeavingEncapsulator next) {
		 ...
		 */
		LocalVariableDeclarator returnVal = new LocalVariableDeclarator(getJoinpoint().getJoinpoint().getTypeReference().clone());
